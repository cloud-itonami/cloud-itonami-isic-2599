# Operator Quickstart — Manufacture of other fabricated metal products n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 2599** (`cloud-itonami-isic-2599`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2599.git
cd cloud-itonami-isic-2599
```
...
- Blueprint governor key: `metal-fab-plant-operations-governor`
- Likely source path: `metalfabmfg.governor.cljc`
