(ns metalfabmfg.phase
  "Phase 0->3 staged rollout for the metal-fabrication shop
  ...
  consequence (a stamping-press/pressing-line/wire-forming-machine
  maintenance window means production downtime, and the equipment ends
  up actually touched); it is always a human shop supervisor's call.
  `metalfabmfg.governor`'s `press-line-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Metal Fabrication Plant Operations Governor verdict to a base
